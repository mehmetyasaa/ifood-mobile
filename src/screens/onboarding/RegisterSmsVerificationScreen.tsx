/**
 * ifood Uygulaması SMS Doğrulama Kodu Ekranı
 * Kayıt olma akışının dördüncü adımı - SMS doğrulama kodu girişi
 */
...
// SMS Doğrulama Kodu Ekranı Bileşeni
export const RegisterSmsVerificationScreen: React.FC = () => {
    ...
    const handleContinue = () => {
        ...
        if (code === '123456') {
            // Kişisel bilgiler ekranına git
            router.push({
                pathname: '/(onboarding)/register-personal-info',
                params: { 
                    email,
                    phone
                }
    ...
    const handleResendCode = () => {
        ...
        console.log('SMS kodu yeniden gönderildi');
    };

    // WhatsApp ile gönder
    const handleWhatsAppSend = () => {
        // WhatsApp ile kod gönderme işlemi
        console.log('WhatsApp ile kod gönderildi');
    };
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                <Text style={styles.title}>SMS ile gönderilen kodu girin</Text>
                <Text style={styles.subtitle}>
                    {phone} numarasına 6 haneli kod gönderdik
                </Text>
                ...
                >
                    <Text style={[
                        ...
                        {isResendDisabled 
                            ? `Kodu yeniden göndermek için ${String(Math.floor(resendCountdown / 60)).padStart(2, '0')}:${String(resendCountdown % 60).padStart(2, '0')} bekleyin`
                            : 'Kodu yeniden gönder'
                        }
                    </Text>
                </TouchableOpacity>
            ...
            <View style={styles.buttonContainer}>
                ...
                {/* WhatsApp ile Gönder - Butonun altında */}
                <TouchableOpacity
                    onPress={handleWhatsAppSend}
                    style={styles.whatsappContainer}
                >
                    <Text style={styles.whatsappText}>WhatsApp ile gönder</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
...
const styles = StyleSheet.create({
    ...
    content: {
        ...
        paddingBottom: SPACING['3XL'], // Sadece buton için alt boşluk
    },
    title: {
    ...
    resendText: {
        fontSize: TYPOGRAPHY.FONT_SIZE.BASE, // Görüntüdeki gibi
        color: COLORS.TEXT_MUTED, // Açık gri renk
        fontWeight: TYPOGRAPHY.FONT_WEIGHT.MEDIUM,
    },
    resendTextDisabled: {
    ...
    whatsappContainer: {
        alignItems: 'center',
        marginTop: SPACING.MD, // Buton ile arasında boşluk
        marginBottom: SPACING.SM,
    },
    whatsappText: {
        fontSize: TYPOGRAPHY.FONT_SIZE.BASE, // Görüntüdeki gibi
        color: COLORS.PRIMARY, // Kırmızı renk
